...
// Função de Movimentação dos personagens (Ben e Biter) //
void movimenta()
{
  jogo.score[0]++;
  lcd.fillRect(0, 28 ,240, 240,BLACK);
  delay(40);
  lcd.drawBitmap(posicoes.pxbiter, posicoes.pybiter, BITER1, 80, 60, WHITE);
  delay(40);
  lcd.drawBitmap(posicoes.pxben, posicoes.pyben, BEN1, 40, 60, WHITE);
  delay(40);
  lcd.fillRect(0, 28 ,240, 240,BLACK);
  delay(40);
  lcd.drawBitmap(posicoes.pxben, posicoes.pyben, BEN2, 40, 60, WHITE);
  delay(40);
  lcd.drawBitmap(posicoes.pxbiter, posicoes.pybiter, BITER2, 80, 60, WHITE);
}
...
void colisao()
{
  if(posicoes.pxben + 20 > posicoes.pxbiter && posicoes.pxben < posicoes.pxbiter + 20 && posicoes.pyben + 55 > posicoes.pybiter && posicoes.pyben < posicoes.pybiter + 50)
  {
...
void condicoes()
{
  ...
  if(posicoes.pyben < 25)
  {
    posicoes.pyben = 25;
  }
  if(posicoes.pyben > 185)
  {
    posicoes.pyben = 185;
  }
}
